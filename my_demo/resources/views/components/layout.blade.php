    ...
    <div class="min-h-full">
        ...
        <nav class="bg-gray-800/50">
                        ...
                        <div class="hidden md:block">
                            ...
                            <div class="ml-4 flex items-center md:ml-6">
                                @guest
                                    ...
                                    <x-nav-link href="/register" :active="request()->is('register')">Inscription</x-nav-link>
                                @endguest

                                @auth
                                        <form method="POST" action="/logout">
                                            @csrf
                                            <x-form-button>Deconnection</x-form-button>
                                        </form>
                                @endauth
                            </div>
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <a href="/" aria-current="page" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Acceuil</a>
                    <a href="/about" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">A propos</a>
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    ...
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Bangoura Abdoulaye</div>
                            <div class="text-sm font-medium text-gray-400">abdoulayebangs2@gmail.com</div>
                        </div>
        ...
        <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
            ...
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                ...
                <x-button href="/jobs/create">Créer une Offre</x-button>
                <x-form-error name="titre"></x-form-error>
            </div>
